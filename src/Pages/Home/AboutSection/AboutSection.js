  ...
  return (
    <div className="text-center font-bold p-16 lg:px-[20%] px-10 mt-10 bg-secondary bg-opacity-20">
      ...
      <p>
        ...
        want, you can sell your used phone here at an attractive price. You can
        also buy the phone at a low price. So why the delay? If you want to
        sell, open a seller account now and advertise your phone.
      </p>
    </div>
  );
};
